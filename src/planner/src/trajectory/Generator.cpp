...
vector<vector<double> > Generator::inference(Trajectory pre_traj_utm, Ego* ego, double vel, int lane) {
    vector<vector<double> > infer;
    infer.emplace_back(map->getXY(s, d));//把当前点加入预测轨迹
